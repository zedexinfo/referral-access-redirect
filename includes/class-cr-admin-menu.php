...
if ( ! class_exists( "RFACRDTCrAdminMenu" ) ) {
	class RFACRDTCrAdminMenu {
		...
		public function RFACRDT_cookie_name_field_validation( $value ) {
			if ( empty( $value ) ) {
				$value = get_option( 'RFACRDT_cookie_name_option' );
		...
		public function RFACRDT_cookie_expiry_time_validation( $value ) {
			if ( empty( $value ) ) {
				$value = get_option( 'RFACRDT_cookie_expiry_option' );
		...
		public function RFACRDT_interval_timeout_validation( $value ) {
			if ( empty( $value ) ) {
				$value = get_option( 'RFACRDT_interval_timeout_option' );
		...
		public function RFACRDT_access_page_url_validation( $value ) {
			if ( empty( $value ) ) {
				$value = get_option( 'RFACRDT_access_page_option' );
		...
		public function RFACRDT_redirect_page_url_validation( $value ) {
			if ( empty( $value ) ) {
				$value = get_option( 'RFACRDT_redirect_page_option' );
		...
		public function RFACRDT_unauthorised_access_message_validation( $value ) {
			if ( empty( $value ) && get_option( 'RFACRDT_redirect_method_option' ) == 'unauthorised_access_message' ) {
				$value = get_option( 'RFACRDT_unauthorised_access_message_option' );
		...
		public function RFACRDT_unauthorised_access_url_field_validation( $value ) {
			if ( empty( $value ) && get_option( 'RFACRDT_redirect_method_option' ) == 'unauthorised_access_page' ) {
				$value = get_option( 'RFACRDT_unauthorised_access_url_option' );
		...
		public function RFACRDT_register_Cd_settings() {
			...
			$admin_menu = apply_filters( 'cd_admin_menu_filter', [
				'RFACRDT_cookie_name_option'                 => array(
					'id'                  => 'cookie_name',
					'title'               => 'Cookie Name',
				...
				'RFACRDT_cookie_expiry_option'               => array(
				...
				'RFACRDT_interval_timeout_option'            => array(
					'id'                  => 'interval_timeout',
				...
				'RFACRDT_access_page_option'                 => array(
					'id'                  => 'access_page_url',
				...
				'RFACRDT_redirect_page_option'               => array(
				...
				'RFACRDT_redirect_method_option'             => array(
					'id'       => 'redirect_method',
				...
				'RFACRDT_unauthorised_access_url_option'     => array(
				...
				'RFACRDT_unauthorised_access_message_option' => array(
				...
				'RFACRDT_delete_values_option'               => array(
					'id'       => 'delete_values',
		...
		public function cookie_name_callback() {
			...
			?>
            <input type="text" name="RFACRDT_cookie_name_option" class="regular-text"
                   value="<?php echo isset( $cookie_name ) ? esc_attr( $cookie_name ) : ''; ?> ">
			<?php
		}

		public function cookie_expiry_callback() {
			$cookie_expiry_time = get_option( 'RFACRDT_cookie_expiry_option' );
			?>
            <input type="text" name="RFACRDT_cookie_expiry_option" class="regular-text"
		...
		public function interval_timeout_callback() {
			...
			?>
            <input type="text" name="RFACRDT_interval_timeout_option" class="regular-text"
                   value="<?php echo isset( $interval_timeout ) ? esc_attr( $interval_timeout ) : ''; ?> ">
			<?php
		}

		public function access_page_callback() {
			$access_page_url = get_option( 'RFACRDT_access_page_option' );
			?>
            <input type="text" name="RFACRDT_access_page_option" class="regular-text"
		...
		public function redirect_page_callback() {
			$redirect_page_url = get_option( 'RFACRDT_redirect_page_option' );
			?>
            <input type="text" name="RFACRDT_redirect_page_option" class="regular-text"
                   value="<?php echo isset( $redirect_page_url ) ? esc_attr( $redirect_page_url ) : ''; ?> ">
			<?php
		}

		public function redirect_method_callback() {
			$redirect_method = get_option( 'RFACRDT_redirect_method_option' );
			?>
            <select type="text" id="method" name="RFACRDT_redirect_method_option" class="regular-text">
		...
		public function unauthorised_access_url_callback() {
			$unauthorised_access_url = get_option( 'RFACRDT_unauthorised_access_url_option' );
			?>
            <input id="unauthorised_access_page_input" type="text" name="RFACRDT_unauthorised_access_url_option"
                   class="regular-text"
		...
		public function unauthorised_access_message_callback() {
			$unauthorised_access_message = get_option( 'RFACRDT_unauthorised_access_message_option' );
			?>
            <input id="unauthorised_access_message_input" type="text" name="RFACRDT_unauthorised_access_message_option"
                   class="regular-text"
		...
		public function delete_values_callback() {
			$delete_values = get_option( 'RFACRDT_delete_values_option' );
			?>
            <input type="checkbox" name="RFACRDT_delete_values_option" value="1" <?php checked( '1', $delete_values ); ?> />
			<?php
		}
	}
}